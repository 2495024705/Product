...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="">首页</a> <a> <cite>会员管理</cite></a>
			...
			href="${ctx }/huiyuan/list" title="刷新"> <i class="layui-icon"
			style="line-height: 30px">ဂ</i></a>
	</div>
	<div class="x-body">
		<div class="layui-row" style="" align="center">
			<form class="layui-form layui-col-md12 x-so" method="get"
				action="${ctx }/huiyuan/list">
		...
		<button class="layui-btn layui-btn-lg"><a  href="${ctx}/huiyuan/add" >新增</a></button>
...
<c:choose>
                ...
                <i class="layui-icon">&#xe601;</i>
							...
							<a title="编辑" href="${ctx}/huiyuan/add?id=${dept.id }"> <i
								class="layui-icon">&#xe642;</i>
							...
							<td>
							<c:choose>
								<c:when test="${dept.ispassed == 0 }">审核未通过</c:when>
