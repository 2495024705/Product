...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="">首页</a> <a> <cite>会员管理</cite></a>
			...
			href="${ctx }/yuangong/list" title="刷新"> <i class="layui-icon"
			style="line-height: 30px">ဂ</i></a>
	</div>
	<div class="x-body">
		<div class="layui-row" style="" align="center">
			<form class="layui-form layui-col-md12 x-so" method="get"
				action="${ctx }/yuangong/list">
			...
			<tbody>
				<c:forEach items="${requestScope.list}" var="dept" varStatus="stat">
					<tr>
						...
						<c:choose>
							<c:when test="${sessionScope.tip  == 1 }">
								<td><c:choose>
										<c:when test="${dept.isUsed == 0 }">审核未通过</c:when>
              ...
              <span class="layui-btn layui-btn-normal layui-btn-mini">已启用</span></td> -->
                ...
                <i class="layui-icon">&#xe601;</i>
									...
									<a title="编辑" href="${ctx}/yuangong/add?id=${dept.id }"> <i
										class="layui-icon">&#xe642;</i>
