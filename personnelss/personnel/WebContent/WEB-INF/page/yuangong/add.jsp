...
<body>
	<div class="x-body">
		<form class="layui-form" method="POST" id="deptForm"
			action="${ctx}/yuangong/add">
			<input type="hidden" name="id" id="id" value="${job.id }">
			
			<c:choose>
				<c:when test="${sessionScope.tip  != 0 }">
<div class="layui-form-item">
				<label for="employeeUuid" class="layui-form-label"> <span
					class="x-red">*</span>员工编号
				</label>
				<div class="layui-input-inline">
					<input type="text" id="employeeUuid" name="employeeUuid"
						required="" lay-verify="required" autocomplete="off"
						class="layui-input" value="${job.employeeUuid }">
				</div>
			...
			<c:choose>
				<c:when test="${sessionScope.tip  != 0 }">
					<div class="layui-form-item">
						<label for="isUsed" class="layui-form-label"> <span
							class="x-red">*</span>审核
						</label>
						<div class="layui-input-inline">
							<select name="isUsed" lay-verify="required">
