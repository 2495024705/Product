...
<body>
	<div class="x-body">
		<form class="layui-form" method="POST" id="deptForm"
			action="${ctx}/fendian/add">
			<input type="hidden" name="id" id="id" value="${job.id }">
			<div class="layui-form-item">
				<label for="fnum" class="layui-form-label"> <span
					class="x-red">*</span>分店编号
				</label>
				<div class="layui-input-inline">
					<input type="text" id="fnum" name="fnum" required=""
		...
		<div class="layui-form-item">
			...
			<div class="layui-form-item">
				<label for="prin" class="layui-form-label"> <span
					class="x-red">*</span>分店负责人
				</label>
				<div class="layui-input-inline">
					<input type="text" id="prin" name="prin" required=""
						lay-verify="required" autocomplete="off" class="layui-input"
						value="${job.prin }">
				</div>
			...
			<div class="layui-form-item">
				<label for="address" class="layui-form-label"> <span
					class="x-red">*</span>分店地址
				</label>
				<div class="layui-input-inline">
					<input type="text" id="address" name="address"
						required="" lay-verify="required" autocomplete="off"
						class="layui-input" value="${job.address }">
				</div>
			</div>
			
			<div class="layui-form-item">
				<label for="remark" class="layui-form-label"> <span
					class="x-red">*</span>分店备注
				</label>
				<div class="layui-input-inline">
