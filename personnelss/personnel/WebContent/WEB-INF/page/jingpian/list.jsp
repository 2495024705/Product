...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="">首页</a> <a> <cite>会员管理</cite></a>
			...
			href="${ctx }/jingpian/list" title="刷新"> <i class="layui-icon"
			style="line-height: 30px">ဂ</i></a>
	</div>
	<div class="x-body">
		<div class="layui-row" style="" align="center">
			<form class="layui-form layui-col-md12 x-so" method="get"
				action="${ctx }/jingpian/list">
				<!-- <input class="layui-input" placeholder="开始日" name="start" id="start">
          <input class="layui-input" placeholder="截止日" name="end" id="end"> -->
				<input type="text" name="content" style="width: 50%;"
					placeholder="请输入查找镜片信息" autocomplete="off" class="layui-input">
...
<div id="xinzheng" class="layui-btn layui-btn-xs" lay-event="edit" >
		<button class="layui-btn layui-btn-lg"><a  href="${ctx}/jingpian/add" >新增</a></button>
			...
			<tbody>
              ...
              <span class="layui-btn layui-btn-normal layui-btn-mini">已启用</span></td> -->
                ...
                <i class="layui-icon">&#xe601;</i>
									...
									<a title="编辑" href="${ctx}/jingpian/add?id=${dept.id }"> <i
										class="layui-icon">&#xe642;</i>
