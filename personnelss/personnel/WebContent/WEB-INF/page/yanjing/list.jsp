...
<body>
	...
	<div id="xinzheng" class="layui-btn layui-btn-xs" lay-event="edit" >
		<button class="layui-btn layui-btn-lg"><a  href="${ctx}/yanjing/add" >新增</a></button>
			...
			<tbody>
              ...
              <span class="layui-btn layui-btn-normal layui-btn-mini">已启用</span></td> -->
                ...
                <i class="layui-icon">&#xe601;</i>
									...
									<a title="编辑" href="${ctx}/yanjing/add?id=${dept.id }"> <i
										class="layui-icon">&#xe642;</i>
