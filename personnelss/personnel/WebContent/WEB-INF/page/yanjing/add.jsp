...
<body>
	<div class="x-body">
		<form class="layui-form" method="POST" id="deptForm"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="yjnum" name="yjnum" required=""
		...
		<div class="layui-form-item">
				<label for="brand" class="layui-form-label"> <span
					class="x-red">*</span>眼镜品牌
				</label>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="number" name="number"
						...
						class="layui-input" value="${job.number }">
				</div>
			</div>
